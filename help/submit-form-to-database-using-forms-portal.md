...
# Forms 포털 {#submit-forms-to-database-using-forms-portal}을(를) 사용하여 적응형 양식을 데이터베이스와 통합
...
1. http://[server]:[port]/system/console/bundles로 이동하고 **[!UICONTROL Install/Update]**&#x200B;를 클릭합니다.
...
### 데이터베이스 {#create-schema-and-tables-in-database}에서 스키마 및 테이블 만들기
...
1. 다음 SQL 문을 사용하여 데이터베이스 스키마에 **commenttable** 테이블을 만듭니다.
...
1. **aem-fp-db-integration-sample-pkg-6.1.2.zip** 패키지를 찾아 **[!UICONTROL OK]**&#x200B;을 클릭합니다.
1. 패키지 옆에 있는 **[!UICONTROL Install]**&#x200B;을 클릭하여 패키지를 설치합니다.

## 변환된 적응형 양식 구성 - Forms 포털 통합 {#configure-converted-adaptive-form-for-forms-portal-integration}

다음 단계를 실행하여 Forms 포털 페이지를 사용하여 적응형 양식 제출을 활성화합니다.
1. [변환을 ](convert-existing-forms-to-adaptive-forms.md#start-the-conversion-process) 실행하여 소스 양식을 응용 양식으로 변환합니다.
...
1. 레이아웃 컨테이너를 누르고 ![템플릿 정책 편집](assets/edit_template_policy.png)을 누릅니다. **[!UICONTROL Allowed Components]** 탭에서 **[!UICONTROL Document Services]** 및 **[!UICONTROL Document Services Predicates]** 옵션을 활성화하고 ![템플릿 정책 저장](assets/edit_template_done.png)을 탭합니다.
1. 페이지에 **[!UICONTROL Search & Lister]** 구성 요소를 삽입합니다. 따라서 AEM 인스턴스에서 사용할 수 있는 기존의 모든 적응형 양식이 페이지에 나열됩니다.
1. 페이지에 **[!UICONTROL Drafts & Submissions]** 구성 요소를 삽입합니다. Forms 포털 페이지에 **[!UICONTROL Draft Forms]** 및 **[!UICONTROL Submitted Forms]** 탭이 두 개 표시됩니다. 또한 **[!UICONTROL Draft Forms]** 탭에는 [Forms 포털 통합에 대해 변환된 적응형 양식 구성](#configure-converted-adaptive-form-for-forms-portal-integration)에 언급된 단계를 사용하여 생성된 전환된 적응형 양식이 표시됩니다.

1. **[!UICONTROL Preview]**&#x200B;을(를) 누르고 변환된 적응형 양식을 누르고 적응형 양식 필드에 대한 값을 지정한 다음 제출합니다. 적응형 양식 필드에 지정한 값이 통합 데이터베이스에 제출됩니다.
